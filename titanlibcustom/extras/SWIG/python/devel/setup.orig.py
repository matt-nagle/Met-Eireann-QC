...
setup(
    ...
    url='https://github.com/metno/titanlibcustom',
    ...
    test_suite="titanlibcustom.tests",
    ...
    #},
    #ext_modules=[Extension('titanlibcustom', ['../titanlibcustom.cpp', '../titanlibcustom_wrap_python.cpp'])]
    ext_modules=[Extension('_titanlibcustom', ['titanlibcustom.cpp', 'titanlibcustom_wrap_python.cpp'],
        swig_opts=['-I./', '-c++'],
        include_dirs=['./'])],
    py_modules=['titanlibcustom'],
