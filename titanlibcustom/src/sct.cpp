...
// start SCT //
ivec titanlibcustom::sct(const Points& points,
        const vec& values,
    ...
    for(int curr=0; curr < s; curr++) {
        if(!titanlibcustom::is_valid(elevs[curr])) {
            flags[curr] = 1;
        }
    }
    ...
    for(int iteration = 0; iteration < num_iterations; iteration++) {
        ...
        for(int curr=0; curr < s; curr++) {
            ...
            vec lons_box = titanlibcustom::subset(lons, neighbour_indices);
            vec elevs_box = titanlibcustom::subset(elevs, neighbour_indices);
            vec lats_box = titanlibcustom::subset(lats, neighbour_indices);
            vec values_box = titanlibcustom::subset(values, neighbour_indices);
            vec eps2_box = titanlibcustom::subset(eps2, neighbour_indices);
            ...
            ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            // MN Edit - print out the backgroud values
            std::cout << "MN - Printing out the background values:" << std::endl;
            ...
            for(int i=0; i < s_box; i++) {
                ...
                for(int j=0; j < s_box; j++) {
                    disth(i, j) = titanlibcustom::calc_distance(lats_box[i], lons_box[i], lats_box[j], lons_box[j]);
                ...
                Dh(i) = titanlibcustom::compute_quantile(0.10, Dh_vector);
            }
            ...
            /* ---------------------------------------------------
               ...
               ------------------------------------------------------*/
            bool b = titanlibcustom::invert_matrix(S, Sinv);
            if(b != true) {
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // MN Edit - print out the values for the prob_gross_error and rep
    std::cout << "MN - Printing out prob_gross_error:" << std::endl;
    for(int i = 0; i < prob_gross_error.size(); i++) {
        std::cout << prob_gross_error[i] << std::endl;
    }

    std::cout << "\nMN - Printing out rep:" << std::endl;
...
vec compute_vertical_profile(const vec& elevs, const vec& oelevs, const vec& values, int num_min_prof, double min_elev_diff) {
    ...
    double exact_p10 = titanlibcustom::compute_quantile(0.10, elevs);
    double exact_p90 = titanlibcustom::compute_quantile(0.90, elevs);
    ...
    double z05 = titanlibcustom::compute_quantile(0.05, elevs);
    double z95 = titanlibcustom::compute_quantile(0.95, elevs);
