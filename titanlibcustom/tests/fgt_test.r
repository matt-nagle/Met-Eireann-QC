titanlibcustom_path <- "../build/extras"
dyn.load( file.path( titanlibcustom_path, paste("SWIG/R/titanlibcustom", .Platform$dynlib.ext, sep="")))
source( file.path( titanlibcustom_path,"SWIG/R/titanlibcustom.R"))
#---------------------------------------------------------------
