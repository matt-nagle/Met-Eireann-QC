...
class SctTest(unittest.TestCase):
    def test_simple(self):
        ...
        flags, sct, rep = titanlibcustom.sct(points0, values0, num_min, num_max, inner_radius,
    ...
    def test_time(self):
        ...
        neg = np.ones(N) * 4;
        eps2 = np.ones(N) * 0.5;
        flags, sct, rep = titanlibcustom.sct(points, values, 5, 100, 4000, 10000, 2, 30, 100, 1000, 100, pos, neg, eps2)
