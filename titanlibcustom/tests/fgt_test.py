...
#        debug = False
#
#        points = titanlibcustom.Points(lats, lons, elevs)
#        flags, score = titanlibcustom.fgt(points, obs_to_check, background_values, background_elab_type, num_min_outer, num_max_outer, inner_radius, outer_radius, num_iterations, num_min_prof, min_elev_diff, min_horizontal_scale, max_horizontal_scale, kth_closest_obs_horizontal_scale, vertical_scale, values_mina, values_maxa, values_minv, values_maxv, eps2, tpos, tneg, debug)
#        print(flags)
#
...
#        print("===============================================================")
    ...
    def test_time(self):
        ...
        background_elab_type = titanlibcustom.VerticalProfileTheilSen
        num_min_outer = 3
        num_max_outer = 50
        inner_radius = 30000
        outer_radius = 50000
        ...
        points = titanlibcustom.Points(lats, lons, elevs)
        flags, score = titanlibcustom.fgt(points, values, obs_to_check, background_values, background_uncertainties, background_elab_type, num_min_outer, num_max_outer, inner_radius, outer_radius, num_iterations, num_min_prof, min_elev_diff, values_mina, values_maxa, values_minv, values_maxv, tpos, tneg, debug)
